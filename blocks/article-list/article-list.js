...
// eslint-disable-next-line no-console
console.log('Current Tag:', currentTagFromUrl);
```
...
if (isTagPage && currentTagFromUrl) {
...
block.innerHTML = `       <div class="article-list-error">
        Unable to load articles.       </div>
    `;
